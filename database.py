...
def _max_bolsa(values_str: str) -> int:
    """Devuelve el valor máximo de un string de mediciones separadas por coma."""
    if not values_str:
        return 0
    try:
        return max(int(v) for v in values_str.split(",") if v.strip())
